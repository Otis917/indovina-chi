...
PERSONAGGI_1 = ["Ai Hayasaka", "Amo"]
PERSONAGGI_2 = ["Nagi Arato", "Ouguri Cup"]
...
if st.session_state.tabella_selezionata is None:
    ...
    with col_a:
        if st.button("📂 GIOCA CON TABELLA 1\n(Hayasaka, Amo)", use_container_width=True):
    ...
    with col_b:
        if st.button("📂 GIOCA CON TABELLA 2\n(Nagi, Ouguri)", use_container_width=True):
